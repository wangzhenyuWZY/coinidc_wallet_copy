<template>
  <div class="owl general regular" ref="owl" :class="[fly, fighting]" @touchstart="touchstart">
    ...
    <div class="body">
      ...
      <div class="clothes">
        <img src="https://owlworld.oss-cn-hongkong.aliyuncs.com/images/skin/general-clothes.png" alt="">
      </div>
      <div class="hat">
        <img src="https://owlworld.oss-cn-hongkong.aliyuncs.com/images/skin/general-hat.png" alt="">
      </div>
      ...
      <div class="bamboo">
        <img src="https://owlworld.oss-cn-hongkong.aliyuncs.com/images/skin/general-spear.png" alt="">
      </div>
