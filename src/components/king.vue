<template>
  <div class="owl king regular" ref="owl" :class="[fly, fighting]" @touchstart="touchstart">
    <div class="shining" v-if="showShining">
      <img src="https://owlworld.oss-cn-hongkong.aliyuncs.com/images/common/shining.jpg" v-if="showShining" alt="">
    </div>
    <div class="body">
      <div class="backrest">
        <img src="https://owlworld.oss-cn-hongkong.aliyuncs.com/images/skin/king-backrest.png" alt="">
      </div>
      ...
      <div class="clothes">
        <img src="https://owlworld.oss-cn-hongkong.aliyuncs.com/images/skin/king-clothes.png" alt="">
      </div>
      <div class="hat">
        <img src="https://owlworld.oss-cn-hongkong.aliyuncs.com/images/skin/king-hat.png" alt="">
      </div>
      <!-- <div class="branch" v-if="defaultBranch">
        <img src="https://owlworld.oss-cn-hongkong.aliyuncs.com/images/common/branch.png" alt="">
      </div> -->
      <div class="throne">
        <img src="https://owlworld.oss-cn-hongkong.aliyuncs.com/images/skin/king-throne.png" alt="">
      </div>
      <slot></slot>
      <div class="feet">
        <div class="left">
      ...
      <div class="head">
        ...
        <div class="eye">
          ...
          <div class="king-eyebrow">
            <img src="https://owlworld.oss-cn-hongkong.aliyuncs.com/images/skin/king-eyebrow.png" alt="">
          </div>
        </div>
        <!-- <div class="mouth">
