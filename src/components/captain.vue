<template>
  <div class="owl captain regular" ref="owl" :class="[fly, fighting]" @touchstart="touchstart">
    ...
    <div class="body">
      ...
      <div class="clothes">
        <img src="https://owlworld.oss-cn-hongkong.aliyuncs.com/images/skin/captain-clothes.png" alt="">
      </div>
      <div class="hat">
        <img src="https://owlworld.oss-cn-hongkong.aliyuncs.com/images/skin/captain-hat.png" alt="">
      </div>
      ...
      <div class="bamboo">
        <img src="https://owlworld.oss-cn-hongkong.aliyuncs.com/images/skin/captain-spear.png" alt="">
      </div>
