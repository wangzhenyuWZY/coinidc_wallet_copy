<template>
  <div class="owl guard regular" ref="owl" :class="[fly, fighting]" @touchstart="touchstart">
    ...
    <div class="body">
      ...
      <div class="clothes">
        <img src="https://owlworld.oss-cn-hongkong.aliyuncs.com/images/skin/guard-clothes.png" alt="">
      </div>
      <div class="hat">
        <img src="https://owlworld.oss-cn-hongkong.aliyuncs.com/images/skin/guard-hat.png" alt="">
      </div>
      ...
      <div class="bamboo">
        <img src="https://owlworld.oss-cn-hongkong.aliyuncs.com/images/skin/guard-spear.png" alt="">
      </div>
