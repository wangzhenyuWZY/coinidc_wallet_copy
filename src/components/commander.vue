<template>
  <div class="owl commander regular" ref="owl" :class="[fly, fighting, lighting]" @touchstart="touchstart">
    ...
    <div class="body">
      ...
      <div class="clothes">
        <img src="https://owlworld.oss-cn-hongkong.aliyuncs.com/images/skin/commander-clothes.png" alt="">
      </div>
      <div class="hat">
        <img src="https://owlworld.oss-cn-hongkong.aliyuncs.com/images/skin/commander-hat.png" alt="">
      </div>
      ...
      <div class="bamboo">
        <img src="https://owlworld.oss-cn-hongkong.aliyuncs.com/images/skin/commander-sword.png" alt="">
      </div>
